		...
		// Wait for selector options
		{
			...
			options: [
				...
				},
				{
					...
					type: 'boolean',
					default: false,
					description: 'Whether to wait until the element is visible in the DOM and on-screen',
				},
				{
					...
					type: 'boolean',
					default: false,
					description: 'Whether to wait until the element is not present in the DOM or is hidden',
				},
			],
			displayOptions: {
				show: {
		...
		// HTML options
		{
			...
			options: [
				...
				},
				{
					...
					type: 'boolean',
					default: true,
					description: 'Whether to include the element\'s outer HTML (when a selector is specified)',
				},
			],
			displayOptions: {
				show: {
			...
			options: [
				{
					...
					type: 'boolean',
					default: true,
					description: 'Whether to trim whitespace from the beginning and end of the extracted text',
				},
			],
			displayOptions: {
				show: {
